      ...
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="firstname" value="<?php echo $firstname; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_firstname; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="lastname" value="<?php echo $lastname; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_lastname; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="email" value="<?php echo $email; ?>" />
            <?php if ($error_email) { ?>
            <span class="error block colorfront"><?php echo $error_email; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="telephone" value="<?php echo $telephone; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_telephone; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo $address_1; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_address_1; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="city" value="<?php echo $city; ?>" />
            <?php if ($error_city) { ?>
            <span class="error block colorfront"><?php echo $error_city; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_postcode; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><select name="country_id">
            ...
            <span class="error block colorfront"><?php echo $error_country; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><select name="zone_id">
            ...
            <?php if ($error_zone) { ?>
            <span class="error block colorfront"><?php echo $error_zone; ?></span>
            <?php } ?></td>
        </tr>
      </table>
    </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php if ($payment == 'cheque') { ?>
              ...
              <?php } ?>
              <label class="inline" for="cheque"><?php echo $text_cheque; ?></label>
              <?php if ($payment == 'paypal') { ?>
              <input type="radio" name="payment" value="paypal" id="paypal" checked="checked" />
              <?php } else { ?>
              <input type="radio" name="payment" value="paypal" id="paypal" />
              <?php } ?>
              <label  class="inline"  for="paypal"><?php echo $text_paypal; ?></label>
              <?php if ($payment == 'bank') { ?>
              <input type="radio" name="payment" value="bank" id="bank" checked="checked" />
              <?php } else { ?>
              <input type="radio" name="payment" value="bank" id="bank" />
              <?php } ?>
              <label  class="inline"  for="bank"><?php echo $text_bank; ?></label></td>
          </tr>
        </tbody>
      ...
      <table class="form">
        <tr>
          ...
          <td><input type="password" name="password" value="<?php echo $password; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_password; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><input type="password" name="confirm" value="<?php echo $confirm; ?>" />
            ...
            <span class="error block colorfront"><?php echo $error_confirm; ?></span>
            <?php } ?></td>
        </tr>
      </table>
    </div>
