      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="company_id" value="<?php echo $company_id; ?>" />
            ...
            <span class="error colorfront"><?php echo $error_company_id; ?></span>
            <?php } ?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td><input type="text" name="tax_id" value="<?php echo $tax_id; ?>" />
            <?php if ($error_tax_id) { ?>
            <span class="error colorfront"><?php echo $error_tax_id; ?></span>
            <?php } ?></td>
        </tr>
        <?php } ?>
        <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo $address_1; ?>" />
            ...
            <span class="error colorfront"><?php echo $error_address_1; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="city" value="<?php echo $city; ?>" />
            <?php if ($error_city) { ?>
            <span class="error colorfront"><?php echo $error_city; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" />
            ...
            <span class="error colorfront"><?php echo $error_postcode; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><select name="country_id">
            ...
            <span class="error colorfront"><?php echo $error_country; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          ...
          <td><select name="zone_id">
            ...
            <?php if ($error_zone) { ?>
            <span class="error colorfront"><?php echo $error_zone; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
