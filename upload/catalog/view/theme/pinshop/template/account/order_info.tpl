  ...
  <table class="table orders">
    <thead>
      <tr>
        ...
        <td class="alcent"><?php echo $column_quantity; ?></td>
    ...
    <tbody>
      ...
      <tr class="numtr<?php if ($num%2 == 0) echo "odd"; else echo "even";?>">
        ...
        <td class="alcent"><?php echo $product['quantity']; ?></td>
        <td class="price"><?php echo $product['price']; ?></td>
        <td class="right"><?php echo $product['total']; ?></td>
        <td class="right"><a href="<?php echo $product['return']; ?>"><i class="icon-shopping-cart"></i><i class="icon-arrow-right"></i></a></td>
      </tr>
      <?php } ?>
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td class="model"></td>
        <td class="price"></td>
        <td class="alright"><b><?php echo $total['title']; ?>:</b></td>
