  ...
  <form class="window" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="row-fluid">
      ...
      <div class="right"><span class="required">*</span> <?php echo $entry_order_id; ?><br />
        ...
        <span class="error colorfront"><?php echo $error_order_id; ?></span>
        <?php } ?>
        <br />
      ...
      <div class="content">
        <div class="return-product">
          <div class="return-name"><span class="required">*</span> <b><?php echo $entry_product; ?></b><br />
            ...
            <span class="error colorfront"><?php echo $error_product; ?></span>
            <?php } ?>
          </div>
          <div class="return-model"><span class="required">*</span> <b><?php echo $entry_model; ?></b><br />
            ...
            <br />
            <?php if ($error_model) { ?>
            <span class="error colorfront"><?php echo $error_model; ?></span>
            <?php } ?>
          </div>
        ...
        <div class="return-detail">
          <div class="return-reason"><span class="required">*</span> <b><?php echo $entry_reason; ?></b><br />
            ...
            <?php if ($error_reason) { ?>
            <span class="error colorfront"><?php echo $error_reason; ?></span>
            <?php } ?>
          </div>
          ...
          <div class="return-captcha"><b><?php echo $entry_captcha; ?></b><br />
            ...
            <span class="error colorfront"><?php echo $error_captcha; ?></span>
            <?php } ?>
          </div>
        </div>
      </div>
