	...
	<tbody>
        ...
        <tr>
          ...
          <td class="quantity"><?php if ($this->config->get('quickcheckout_edit_cart')) { ?>
			...
			<a href="<?php echo $product['remove']; ?>" class="button-remove"><img src="catalog/view/theme/default/image/quickcheckout-remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a>
			<?php } else { ?>
		...
		<?php foreach ($totals as $total) { ?>
			<tr>
				<td></td>
				<td></td>
				<td style="text-align:right;" colspan="2"><b><?php echo $total['title']; ?>:</b></td>
