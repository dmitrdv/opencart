...
<div id="success-messages"></div>
  ...
  <div id="quickcheckoutconfirm"><!-- Start -->
...
function reloadPaymentMethod(country_id, zone_id, isset, city, postcode) {
	$.ajax({
		...
		data: {country_id: country_id, zone_id: zone_id, isset: isset, city: city, postcode: postcode, survey: $('textarea[name=\'survey\']').val()},
		dataType: 'html',
		beforeSend: function() {
...
function reloadPaymentMethodById(address_id) {
	$.ajax({
		url: 'index.php?route=quickcheckout/payment_method',
		data: {address_id: address_id, survey: $('textarea[name=\'survey\']').val()},
		dataType: 'html',
		beforeSend: function() {
			$('#payment-method .quickcheckout-content').html('<div class="wait" style="wdith:100%;text-align:center;">&nbsp;<img src="catalog/view/theme/default/image/quickcheckout-loading.gif" alt="" /></div>');
		},	
...
<?php if ($shipping_required) { ?>
	function reloadShippingMethod(country_id, zone_id, isset, city, postcode) {
		$.ajax({
			...
			data: {country_id: country_id, zone_id: zone_id, isset: isset, city: city, postcode: postcode, delivery_date: $('input[name=\'delivery_date\']').val()},
			dataType: 'html',
			beforeSend: function() {
	...
	function reloadShippingMethodById(address_id) {
		$.ajax({
			url: 'index.php?route=quickcheckout/shipping_method',
			data: {address_id: address_id, delivery_date: $('input[name=\'delivery_date\']').val()},
			dataType: 'html',
			beforeSend: function() {
				$('#shipping-method .quickcheckout-content').html('<div class="wait" style="width:100%;text-align:center;">&nbsp;<img src="catalog/view/theme/default/image/quickcheckout-loading.gif" alt="" /></div>');
			},	
...
$(document).ready(function() {
	$.ajax({
		...
		dataType: 'html',
		beforeSend: function() {
			$('#voucher .quickcheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/default/image/quickcheckout-loading.gif" alt="" /></span>');
		},	
		success: function(html) {
