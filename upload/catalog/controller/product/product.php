		...
		if ($product_info) {
			...
			if ($product_info['image']) {
                ...
                if (file_exists($pageURL.$product_info['image'])) {
                    ...
                    if ($this->config->get('config_image_thumb_width') != 228) $width = $this->config->get('config_image_thumb_width'); else $width  = 650;
    			    $this->data['thumb'] = $this->model_tool_image->resize($product_info['image'], $width, ($imgsize[1]/($imgsize[0]/$width)));
                } else $image= false;
