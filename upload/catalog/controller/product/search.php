...
class ControllerProductSearch extends Controller { 	
	public function index() { 
		...
		if (isset($this->request->get['filter_name'])) {
			$this->document->setTitle($this->request->get['filter_name']);
		} else {
        ...
        if (isset($this->request->get['category_id'])) $category_id = $this->request->get['category_id']; else $category_id = 0;
        if (isset($this->request->get['filter_category_id'])) $filter_category_id = $this->request->get['filter_category_id']; else $filter_category_id = 0;
        
        if (isset($this->request->get['filter_name'])) $filter_name = $this->request->get['filter_name']; else $filter_name = '';
        if (isset($this->request->get['filter_tag'])) $filter_tag = $this->request->get['filter_tag']; else $filter_tag = '';
        if (isset($this->request->get['filter_description'])) $filter_description = $this->request->get['filter_description']; else $filter_description = '';
        ...
        if (isset($this->request->get['filter_manufacturer_id'])) $filter_manufacturer_id = $this->request->get['filter_manufacturer_id']; else $filter_manufacturer_id = '';
		...
		if (isset($this->request->get['filter_name'])) {
    		$this->data['heading_title'] = '<i class="icon-search"></i>&nbsp;'.$this->request->get['filter_name'];
		} elseif (isset($this->request->get['filter_tag'])) {
    		$this->data['heading_title'] = '<i class="icon-search"></i>&nbsp;'.$this->request->get['filter_tag'];
		} else {
