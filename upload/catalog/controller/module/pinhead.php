<?php 
class ControllerModulePinhead extends Controller {
    protected function index() {
        $this->language->load('module/pinhead');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pinhead.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/pinhead.tpl';
		} else {
			$this->template = 'default/template/module/pinhead.tpl';
		}			
	...
	public function info() {
        ...
        if (isset($this->request->get['category_id'])) $order = $this->request->get['category_id']; else $category_id = 0;
        ...
        if (isset($this->request->get['manufacturer_id'])) $filter_manufacturer_id = $this->request->get['manufacturer_id']; else $filter_manufacturer_id = '';
