...
class ControllerQuickCheckoutShippingMethod extends Controller {
  	public function index() {
		...
		if (isset($this->request->get['address_id']) && $this->request->get['address_id']) {
			...
			$shipping_address['country'] = $this->session->data['guest']['shipping']['country'];
			$shipping_address['iso_code_2'] = $this->session->data['guest']['shipping']['iso_code_2'];
			$shipping_address['iso_code_3'] = $this->session->data['guest']['shipping']['iso_code_3'];
			$shipping_address['address_format'] = $this->session->data['guest']['shipping']['address_format'];
			...
			$shipping_address['zone'] = $this->session->data['guest']['shipping']['zone'];
			$shipping_address['zone_code'] = $this->session->data['guest']['shipping']['zone_code'];
